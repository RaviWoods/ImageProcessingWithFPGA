...
//  Generated date: Mon May 11 14:26:49 2015
// ----------------------------------------------------------------------
...
module static_anaglyph_core (
  ...
  begin : core
    ...
    reg [629:0] io_read_video_in_rsc_d_cse_sva;
    ...
    begin : mainExit
      forever begin : main
        ...
        if ( main_stage_0_3 ) begin
          ...
          video_out_rsc_mgc_out_stdreg_d <= {(fslr_10_630_13(io_read_video_in_rsc_d_cse_sva_2,
              ({((left_adjust_sg1_sva[11:1]) + 11'b101) , (left_adjust_sg1_sva[0])
              , 1'b0}))) , (fslr_10_630_17(io_read_video_in_rsc_d_cse_sva_2, ({(conv_u2u_15_16({{2{acc_20_psp_sva[12]}},
              acc_20_psp_sva}) + 16'b101) , 1'b0}))) , (readslicef_11_10_1((conv_u2u_10_11(fslr_10_630_13(io_read_video_in_rsc_d_cse_sva_2,
              ({left_adjust_sg1_sva , 1'b0}))) + conv_u2u_10_11(fslr_10_630_16(io_read_video_in_rsc_d_cse_sva_2,
    ...
    acc_imod_sva = 4'b0;
    acc_idiv_sva = 12'b0;
    io_read_video_in_rsc_d_cse_sva = 630'b0;
    div_mgc_div_1_b <= 10'b0;
    div_mgc_div_b <= 10'b0;
  ...
  function [9:0] fslr_10_630_13;
    input [629:0] data;
    input [12:0] shft;
  begin
    fslr_10_630_13 = data >> shft;
  end
  endfunction


  function [9:0] fslr_10_630_17;
    input [629:0] data;
    input [16:0] shft;
  begin
    fslr_10_630_17 = data >> shft;
  end
  endfunction
  ...
  function [9:0] fslr_10_630_16;
    input [629:0] data;
    input [15:0] shft;
  begin
    fslr_10_630_16 = data >> shft;
  end
  endfunction
