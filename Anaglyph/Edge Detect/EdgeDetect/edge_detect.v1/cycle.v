...
//  Generated date: Mon May 11 14:42:32 2015
// ----------------------------------------------------------------------
...
module edge_detect_core (
  ...
  begin : core
    ...
    reg [15:0] absmax_absmax_return_3_sva_2;
    reg [15:0] absmax_absmax_return_3_lpi_1_dfm_1;
    reg [15:0] red_sva_2;
        ...
        begin : mainExit
          forever begin : main
            ...
            if ( main_stage_0_2 ) begin
              ...
              absmax_absmax_return_3_sva_2 = 16'b0;
                    ...
                    if ( exit_ACC4_sva_2_st_1 ) begin
                      ...
                      if ( absmax_3_slc_svs ) begin
                        ...
                        if ( absmax_3_else_slc_svs ) begin
                          ...
                          absmax_absmax_return_3_sva_2 = (~ FRAME_avg_sva) + 16'b1;
                        end
                      end
                      absmax_absmax_return_3_lpi_1_dfm_1 = MUX1HOT_v_16_3_2({absmax_absmax_return_3_sva_2
                          , ({6'b0, FRAME_avg_sva[9:0]}) , 16'b1111111111}, {(~(absmax_3_else_slc_svs
                          | absmax_3_slc_svs)) , (absmax_3_else_slc_svs & (~ absmax_3_slc_svs))
                          , absmax_3_slc_svs});
                      vout_rsc_mgc_out_stdreg_d <= {((absmax_absmax_return_3_lpi_1_dfm_1[9:0])
                          | ({4'b0, absmax_absmax_return_3_lpi_1_dfm_1[15:10]}))
                          , (absmax_absmax_return_3_lpi_1_dfm_1[9:6]) , ((absmax_absmax_return_3_lpi_1_dfm_1[5:0])
                          | (absmax_absmax_return_3_lpi_1_dfm_1[15:10])) , (absmax_absmax_return_3_lpi_1_dfm_1[9:0])};
                    end
                  end
                end
              end
    ...
    green_sva_2 = 16'b0;
    red_sva_2 = 16'b0;
    absmax_absmax_return_3_lpi_1_dfm_1 = 16'b0;
    absmax_absmax_return_3_sva_2 = 16'b0;
    absmax_3_else_slc_svs = 1'b0;
