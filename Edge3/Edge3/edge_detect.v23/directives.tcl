...
//  
project new
solution file add {../edge_detect_c/edge.h} -type CHEADER
solution file add {../edge_detect_c/shift_class.h} -type CHEADER
solution file add {../edge_detect_c/edge6.c} -type C++
...
directive set -CLOCKS {clk {-CLOCK_PERIOD 10.0 -CLOCK_EDGE rising -CLOCK_UNCERTAINTY 0.0 -CLOCK_HIGH_TIME 5.0 -RESET_SYNC_NAME rst -RESET_ASYNC_NAME arst_n -RESET_KIND async -RESET_SYNC_ACTIVE high -RESET_ASYNC_ACTIVE low -ENABLE_NAME en -ENABLE_ACTIVE high}}
go compile
directive set /edge_detect/core/ACC_GY:for -UNROLL yes
directive set /edge_detect/core/ACC_GX:for -UNROLL yes
