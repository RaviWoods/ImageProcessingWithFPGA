...
//  
//  Running on Windows 7 jb914@EEWS104A-020 Service Pack 1 6.01.7601 i686
//  
...
solution file add {../motionblur/motionblur.h} -type CHEADER
solution file add {../motionblur/motionblur2.c} -type C++
...
go analyze
directive set -DESIGN_HIERARCHY absmax__F32ac_int__tm__18_XCiL_2_16XCbL_1_1
...
go compile
directive set /motion_blur/core/ACC2 -UNROLL yes
directive set /motion_blur/core/ACC1 -UNROLL yes
directive set /motion_blur/core/SHIFT -UNROLL yes
directive set /motion_blur/core/main -UNROLL 1
directive set /motion_blur/core/main -DISTRIBUTED_PIPELINE true
directive set /motion_blur/core/main -PIPELINE_INIT_INTERVAL 1
directive set /edge_detect/core/ACC4 -UNROLL yes
directive set /edge_detect/core/ACC3 -UNROLL yes
directive set /edge_detect/core/ACC2 -UNROLL yes
directive set /edge_detect/core/ACC1 -UNROLL yes
directive set /edge_detect/core/SHIFT -UNROLL yes
...
directive set /edge_detect/core/main -UNROLL 1
directive set /edge_detect/vout -STREAM 0
directive set /edge_detect/vin -STREAM 0
go architect
