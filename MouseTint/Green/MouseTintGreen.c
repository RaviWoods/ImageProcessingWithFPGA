...
//
////////////////////////////////////////////////////////////////////////////////
//  File:           MouseTintGreen.c
//  Description:    Green tint with mouse-x control
//  By:             jb914
////////////////////////////////////////////////////////////////////////////////
// Catapult Project options
// Constraint Editor:
//  Frequency: 27 MHz
//  Top design: green_tint
...
void green_tint(ac_int<PIXEL_WL, false> * video_in, ac_int<PIXEL_WL, false> * video_out, ac_int<(COORD_WL+COORD_WL), false> * mouse_xy)
{
