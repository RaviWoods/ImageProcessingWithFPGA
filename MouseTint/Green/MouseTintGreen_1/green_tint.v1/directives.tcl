...
solution file add {./MouseTintGreen.c} -type C++
...
directive set -DESIGN_HIERARCHY green_tint
go compile
directive set /green_tint/core/main -DISTRIBUTED_PIPELINE true
directive set /green_tint/core/main -PIPELINE_INIT_INTERVAL 1
go architect
go extract
