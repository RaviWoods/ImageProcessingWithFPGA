...
//  
//  Running on Windows 7 jb914@EEWS104A-014 Service Pack 1 6.01.7601 i686
//  
...
solution file add {./MouseTintRed.c} -type C++
...
directive set -CLOCKS {clk {-CLOCK_PERIOD 37.037037037 -CLOCK_EDGE rising -CLOCK_UNCERTAINTY 0.0 -CLOCK_HIGH_TIME 18.52 -RESET_SYNC_NAME rst -RESET_ASYNC_NAME arst_n -RESET_KIND sync -RESET_SYNC_ACTIVE high -RESET_ASYNC_ACTIVE low -ENABLE_NAME {} -ENABLE_ACTIVE high}}
...
directive set -DESIGN_HIERARCHY red_tint
go compile
directive set /red_tint/core/main -DISTRIBUTED_PIPELINE true
directive set /red_tint/core/main -PIPELINE_INIT_INTERVAL 1
go architect
