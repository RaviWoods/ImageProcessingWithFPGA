...
//  Generated date: Wed May 06 13:20:19 2015
// ----------------------------------------------------------------------
...
module red_tint_core (
  ...
  begin : core
    ...
    reg[7:0] makepos_mux_nl;
    reg[7:0] else_mux1h_nl;
      ...
      forever begin : main
        ...
        if ( slc_svs ) begin
          ...
          if ( else_slc_svs ) begin
            ...
            makepos_slc_svs = readslicef_10_1_9((else_else_acc_psp_sva + 10'b1111111011));
            ...
            else_else_acc_2_psp_sva = readslicef_11_10_1((conv_u2u_9_11({(io_read_video_in_rsc_d_cse_sva[9:2])
                , 1'b1}) + conv_s2u_9_11({(~ mouse_x_1_sva) , 1'b1})));
            makepos_1_slc_svs = readslicef_10_1_9((else_else_acc_2_psp_sva + 10'b1111111011));
          ...
          redout_lpi_dfm = (io_read_video_in_rsc_d_cse_sva[29:20]) & (signext_10_1(~
              else_slc_svs));
          makepos_mux_nl = MUX_v_8_2_2({makepos_result_sg1_lpi_dfm , 8'b101}, makepos_slc_svs);
          mux_11 = (makepos_mux_nl) & (signext_8_1(~ else_slc_svs));
          mux_12 = makepos_result_1_lpi_dfm_1 & (signext_2_1(~ else_slc_svs));
        end
        else_mux1h_nl = MUX1HOT_v_8_3_2({makepos_1_result_sg1_lpi_dfm , 8'b101 ,
            (io_read_video_in_rsc_d_cse_sva[9:2])}, {(~(makepos_1_slc_svs | else_slc_svs))
            , (makepos_1_slc_svs & (~ else_slc_svs)) , else_slc_svs});
        ...
        video_out_rsc_mgc_out_stdreg_d <= {(redout_lpi_dfm & (signext_10_1(~ slc_svs)))
            , mux_11 , mux_12 , ((else_mux1h_nl) & (signext_8_1(~ slc_svs))) , ((else_mux_6_nl)
            & (signext_2_1(~ slc_svs)))};
      end
    end
    mux_12 = 2'b0;
