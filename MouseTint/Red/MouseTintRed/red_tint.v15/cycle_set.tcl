...
directive set /red_tint/core/main/makepos:else:and CSTEPS_FROM {{.. == 1}}
directive set /red_tint/core/main/makepos:else:and#1 CSTEPS_FROM {{.. == 1}}
...
directive set /red_tint/core/main/makepos#1:else:and CSTEPS_FROM {{.. == 1}}
directive set /red_tint/core/main/makepos#1:else:and#1 CSTEPS_FROM {{.. == 1}}
