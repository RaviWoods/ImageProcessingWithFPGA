...
directive set /red_tint/core/main/mux#1 CSTEPS_FROM {{.. == 1}}
directive set /red_tint/core/main/mux#2 CSTEPS_FROM {{.. == 1}}
directive set /red_tint/core/main/else:mux#3 CSTEPS_FROM {{.. == 1}}
directive set /red_tint/core/main/and#1 CSTEPS_FROM {{.. == 1}}
directive set /red_tint/core/main/else:mux#4 CSTEPS_FROM {{.. == 1}}
