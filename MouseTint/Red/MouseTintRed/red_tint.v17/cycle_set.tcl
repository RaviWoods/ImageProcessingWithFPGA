...
directive set /red_tint/core/main/else:and#3 CSTEPS_FROM {{.. == 1}}
directive set /red_tint/core/main/else:and#4 CSTEPS_FROM {{.. == 1}}
...
directive set /red_tint/core/main/and#3 CSTEPS_FROM {{.. == 1}}
directive set /red_tint/core/main/and#4 CSTEPS_FROM {{.. == 1}}
