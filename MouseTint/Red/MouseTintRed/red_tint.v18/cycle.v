...
//  Generated date: Wed May 06 13:42:39 2015
// ----------------------------------------------------------------------
      ...
      forever begin : main
        ...
        if ( slc_svs ) begin
          ...
          redout_lpi_dfm = (io_read_video_in_rsc_d_cse_sva[29:20]) & (signext_10_1(~
              (mouse_x_1_sva[7])));
          greenout_sg1_lpi_dfm = makepos_result_sg1_lpi_dfm & (signext_8_1(~ (mouse_x_1_sva[7])));
          greenout_1_lpi_dfm = makepos_result_1_lpi_dfm & (signext_2_1(~ (mouse_x_1_sva[7])));
          blueout_sg1_lpi_dfm = makepos_1_result_sg1_lpi_dfm & (signext_8_1(~ (mouse_x_1_sva[7])));
          blueout_1_lpi_dfm = makepos_1_result_1_lpi_dfm & (signext_2_1(~ (mouse_x_1_sva[7])));
        end
