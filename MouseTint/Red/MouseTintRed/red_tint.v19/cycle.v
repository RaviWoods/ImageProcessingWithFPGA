...
//  Generated date: Wed May 06 13:43:54 2015
// ----------------------------------------------------------------------
  ...
  begin : core
    ...
    begin : mainExit
      forever begin : main
        ...
        else_else_acc_psp_sva_sg1 = readslicef_11_10_1((conv_u2u_10_11({(io_read_video_in_rsc_d_1_cse_sva[19:11])
            , 1'b1}) + conv_s2u_10_11({1'b1 , (~ slc_mouse_xy_psp_sva) , 1'b1})));
        else_else_acc_1_psp_sva_sg1 = readslicef_11_10_1((conv_u2u_10_11({(io_read_video_in_rsc_d_1_cse_sva[9:1])
            , 1'b1}) + conv_s2u_10_11({1'b1 , (~ slc_mouse_xy_psp_sva) , 1'b1})));
        video_out_rsc_mgc_out_stdreg_d <= {(io_read_video_in_rsc_d_1_cse_sva[29:20])
            , (({(else_else_acc_psp_sva_sg1[8:0]) , (readslicef_2_1_1((({(io_read_video_in_rsc_d_1_cse_sva[10])
            , 1'b1}) + 2'b11)))}) & (signext_10_1(~ (else_else_acc_psp_sva_sg1[9]))))
            , (({(else_else_acc_1_psp_sva_sg1[8:0]) , (readslicef_2_1_1((({(io_read_video_in_rsc_d_1_cse_sva[0])
