...
directive set /red_tint/core/main/if:acc#2 CSTEPS_FROM {{.. == 1}}
directive set /red_tint/core/main/makepos:if:acc CSTEPS_FROM {{.. == 1}}
directive set /red_tint/core/main/makepos:else:if:acc CSTEPS_FROM {{.. == 1}}
...
directive set /red_tint/core/main/makepos#1:else:if:acc CSTEPS_FROM {{.. == 1}}
