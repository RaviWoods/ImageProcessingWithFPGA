...
//  Generated date: Wed May 06 12:12:16 2015
// ----------------------------------------------------------------------
  ...
  begin : core
    ...
    begin : mainExit
      forever begin : main
        ...
        mouse_x_1_sva = mouse_xy_rsc_mgc_in_wire_d[7:0];
        ...
        if ( slc_svs ) begin
          ...
          if ( makepos_slc_svs ) begin
            ...
            makepos_else_slc_svs = readslicef_8_1_7(((if_acc_psp_sva[10:3]) + 8'b10000011));
          end
          makepos_else_mux_nl = MUX_v_10_2_2({(signext_10_1(if_acc_psp_sva[10]))
          ...
          if ( makepos_1_slc_svs ) begin
            ...
            makepos_1_else_slc_svs = readslicef_8_1_7(((if_acc_1_psp_sva[10:3]) +
                8'b10000011));
          end
          makepos_1_else_mux_nl = MUX_v_10_2_2({(signext_10_1(if_acc_1_psp_sva[10]))
