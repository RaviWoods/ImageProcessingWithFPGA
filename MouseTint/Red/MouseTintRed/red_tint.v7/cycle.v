...
//  Generated date: Wed May 06 12:34:40 2015
// ----------------------------------------------------------------------
...
module red_tint_core (
  ...
  begin : core
    ...
    reg [7:0] acc_2_psp_sva;
    reg [29:0] io_read_video_in_rsc_d_1_cse_sva;
    reg [11:0] acc_psp_sva;
    reg [9:0] makepos_result_lpi_dfm;
    reg [11:0] acc_1_psp_sva;
    reg [9:0] makepos_1_result_lpi_dfm;
    ...
    begin : mainExit
      forever begin : main
        ...
        makepos_1_result_lpi_dfm = 10'b0;
        makepos_result_lpi_dfm = 10'b0;
        mouse_x_1_sva = mouse_xy_rsc_mgc_in_wire_d[8:1];
        acc_2_psp_sva = conv_u2u_6_8(mouse_x_1_sva[7:2]) + mouse_x_1_sva;
        io_read_video_in_rsc_d_1_cse_sva = video_in_rsc_mgc_in_wire_d;
        acc_psp_sva = readslicef_13_12_1((conv_u2s_11_13({(io_read_video_in_rsc_d_1_cse_sva[19:10])
            , 1'b1}) + conv_s2s_11_13({(~ acc_2_psp_sva) , (~ (mouse_x_1_sva[1:0]))
            , 1'b1})));
        if ( acc_psp_sva[11] ) begin
        end
        else begin
          makepos_result_lpi_dfm = (acc_psp_sva[9:0]) | (signext_10_1(acc_psp_sva[10]));
        end
        acc_1_psp_sva = readslicef_13_12_1((conv_u2s_11_13({(io_read_video_in_rsc_d_1_cse_sva[9:0])
            , 1'b1}) + conv_s2s_11_13({(~ acc_2_psp_sva) , (~ (mouse_x_1_sva[1:0]))
            , 1'b1})));
        if ( acc_1_psp_sva[11] ) begin
        end
        else begin
          makepos_1_result_lpi_dfm = (acc_1_psp_sva[9:0]) | (signext_10_1(acc_1_psp_sva[10]));
        end
        video_out_rsc_mgc_out_stdreg_d <= {(io_read_video_in_rsc_d_1_cse_sva[29:20])
            , (makepos_result_lpi_dfm & (signext_10_1(~ (acc_psp_sva[11])))) , (makepos_1_result_lpi_dfm
            & (signext_10_1(~ (acc_1_psp_sva[11]))))};
      end
    end
    makepos_1_result_lpi_dfm = 10'b0;
    acc_1_psp_sva = 12'b0;
