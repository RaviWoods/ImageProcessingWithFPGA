...
void sharpen_detect(ac_int<PIXEL_WL*KERNEL_WIDTH,false> vin[NUM_PIXELS], ac_int<PIXEL_WL,false> vout[NUM_PIXELS])
{
	...
	const ac_int<16,true> g_x[9] = {-1,-1,-1,-1,9,-1,-1,-1,-1};
