...
//  Generated date: Tue May 05 15:06:30 2015
// ----------------------------------------------------------------------
    ...
    begin : mainExit
      forever begin : main
        ...
        if ( acc_1_psp_sva[11] ) begin
          ...
          makepos_else_else_slc_svs = readslicef_10_1_9(((~ (acc_1_psp_sva[9:0]))
              + 10'b1));
        end
        ...
        if ( acc_2_psp_sva[11] ) begin
          ...
          makepos_1_else_else_slc_svs = readslicef_10_1_9(((~ (acc_2_psp_sva[9:0]))
              + 10'b1));
        end
