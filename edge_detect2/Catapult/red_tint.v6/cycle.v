...
//  Generated date: Tue May 05 15:20:41 2015
// ----------------------------------------------------------------------
    ...
    begin : mainExit
      forever begin : main
        ...
        if ( acc_1_psp_sva[11] ) begin
          ...
          makepos_else_slc_svs = readslicef_9_1_8((conv_u2u_8_9(acc_1_psp_sva[10:3])
              + 9'b110000011));
          if ( makepos_else_slc_svs ) begin
          end
          else begin
            makepos_else_else_slc_svs = readslicef_12_1_11((({1'b1 , (~ (acc_1_psp_sva[10:0]))})
                + 12'b10000000001));
          end
        end
        acc_2_psp_sva = readslicef_13_12_1((conv_u2s_11_13({(io_read_video_in_rsc_d_1_cse_sva[9:0])
            , 1'b1}) + conv_s2s_11_13({(~ acc_psp_sva) , (~ (mouse_x_2_sva[0])) ,
            2'b1})));
        if ( acc_2_psp_sva[11] ) begin
        end
        else begin
          makepos_1_else_slc_svs = readslicef_9_1_8((conv_u2u_8_9(acc_2_psp_sva[10:3])
              + 9'b110000011));
          if ( makepos_1_else_slc_svs ) begin
          end
          else begin
            makepos_1_else_else_slc_svs = readslicef_12_1_11((({1'b1 , (~ (acc_2_psp_sva[10:0]))})
                + 12'b10000000001));
          end
        end
        makepos_else_mux_nl = MUX_v_10_2_2({(signext_10_1(~ makepos_else_else_slc_svs))
            , (acc_1_psp_sva[9:0])}, makepos_else_slc_svs);
        makepos_1_else_mux_nl = MUX_v_10_2_2({(signext_10_1(~ makepos_1_else_else_slc_svs))
            , (acc_2_psp_sva[9:0])}, makepos_1_else_slc_svs);
        video_out_rsc_mgc_out_stdreg_d <= {(io_read_video_in_rsc_d_1_cse_sva[29:20])
            , ((makepos_else_mux_nl) & (signext_10_1(~ (acc_1_psp_sva[11])))) , ((makepos_1_else_mux_nl)
            & (signext_10_1(~ (acc_2_psp_sva[11]))))};
      end
    end
    makepos_1_else_else_slc_svs = 1'b0;
