...
//  Generated date: Mon May 11 12:55:13 2015
// ----------------------------------------------------------------------
...
module motion_blur_core (
  ...
  begin : core
    ...
    reg [2:0] FRAME_acc_7_sdt;
    reg [2:0] FRAME_acc_11_sdt;
    reg [2:0] FRAME_acc_21_sdt;
      ...
      forever begin : core_rlp
        ...
        begin : mainExit
          forever begin : main
            ...
            absmax_absmax_return_3_lpi_1_dfm_1 = absmax_absmax_return_3_lpi_1_dfm
            ...
            absmax_absmax_return_4_lpi_1_dfm_1 = absmax_absmax_return_4_lpi_1_dfm
                | ({{9{absmax_1_slc_svs}}, absmax_1_slc_svs});
            ...
            absmax_absmax_return_5_lpi_1_dfm_1 = absmax_absmax_return_5_lpi_1_dfm
                | ({{9{absmax_2_slc_svs}}, absmax_2_slc_svs});
            FRAME_acc_7_sdt = conv_u2u_2_3(~ (absmax_absmax_return_3_lpi_1_dfm_1[3:2]))
                + conv_u2u_2_3(absmax_absmax_return_3_lpi_1_dfm_1[5:4]);
            acc_imod_sva = conv_s2s_4_5({(conv_u2u_2_3(FRAME_acc_7_sdt[2:1]) + 3'b101)
                , (FRAME_acc_7_sdt[0])}) + conv_u2s_4_5(conv_u2u_3_4(conv_u2u_2_3(~
                (absmax_absmax_return_3_lpi_1_dfm_1[7:6])) + conv_u2u_2_3(absmax_absmax_return_3_lpi_1_dfm_1[9:8]))
                + conv_u2u_2_4(absmax_absmax_return_3_lpi_1_dfm_1[1:0]));
            FRAME_acc_11_sdt = conv_u2u_2_3(~ (absmax_absmax_return_5_lpi_1_dfm_1[3:2]))
                + conv_u2u_2_3(absmax_absmax_return_5_lpi_1_dfm_1[5:4]);
            acc_imod_2_sva = conv_s2s_4_5({(conv_u2u_2_3(FRAME_acc_11_sdt[2:1]) +
                3'b101) , (FRAME_acc_11_sdt[0])}) + conv_u2s_4_5(conv_u2u_3_4(conv_u2u_2_3(~
            ...
            FRAME_acc_3_psp_1_sva = conv_s2s_7_9(conv_u2s_6_8(conv_u2s_12_7(conv_u2u_2_6(absmax_absmax_return_5_lpi_1_dfm_1[7:6])
                * 6'b1101)) + conv_s2s_5_7(conv_s2s_4_5(({2'b10 , (absmax_absmax_return_5_lpi_1_dfm_1[3:2])})
                ...
                + conv_u2s_8_10(conv_u2s_16_9(conv_u2u_2_8(absmax_absmax_return_5_lpi_1_dfm_1[9:8])
                * 8'b110011));
            FRAME_acc_21_sdt = conv_u2u_2_3(~ (absmax_absmax_return_4_lpi_1_dfm_1[3:2]))
                + conv_u2u_2_3(absmax_absmax_return_4_lpi_1_dfm_1[5:4]);
            acc_imod_4_sva = conv_s2s_4_5({(conv_u2u_2_3(FRAME_acc_21_sdt[2:1]) +
                3'b101) , (FRAME_acc_21_sdt[0])}) + conv_u2s_4_5(conv_u2u_3_4(conv_u2u_2_3(~
            ...
            vout_rsc_mgc_out_stdreg_d <= {(signext_10_9(conv_s2s_7_9(conv_u2s_6_8(conv_u2s_12_7(conv_u2u_2_6(absmax_absmax_return_3_lpi_1_dfm_1[7:6])
                * 6'b1101)) + conv_s2s_5_7(conv_s2s_4_5(({2'b10 , (absmax_absmax_return_3_lpi_1_dfm_1[3:2])})
                ...
                (acc_imod_sva[3:2])) , (~ (acc_imod_sva[4]))})))))})))) + conv_u2s_8_10(conv_u2s_16_9(conv_u2u_2_8(absmax_absmax_return_3_lpi_1_dfm_1[9:8])
                * 8'b110011)))) , (signext_4_3(FRAME_acc_3_psp_1_sva[8:6])) , (FRAME_acc_3_psp_1_sva[5:0])
                , (signext_10_9(conv_s2s_7_9(conv_u2s_6_8(conv_u2s_12_7(conv_u2u_2_6(absmax_absmax_return_4_lpi_1_dfm_1[7:6])
                * 6'b1101)) + conv_s2s_5_7(conv_s2s_4_5(({2'b10 , (absmax_absmax_return_4_lpi_1_dfm_1[3:2])})
                ...
                + conv_u2s_8_10(conv_u2s_16_9(conv_u2u_2_8(absmax_absmax_return_4_lpi_1_dfm_1[9:8])
                * 8'b110011))))};
    ...
    FRAME_acc_21_sdt = 3'b0;
    FRAME_acc_11_sdt = 3'b0;
    FRAME_acc_7_sdt = 3'b0;
