...
solution file add {./motionblur.h} -type CHEADER
solution file add {./motionblur1.c} -type C++
...
directive set /motion_blur/vout -STREAM 30
directive set /motion_blur/vin -STREAM 150
go architect
go extract
