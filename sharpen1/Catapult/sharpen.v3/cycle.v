...
//  Generated date: Fri May 01 16:35:54 2015
// ----------------------------------------------------------------------
...
module sharpen_core (
  ...
  begin : core
    ...
    reg [5:0] ACC_GX_for_acc_16_psp_sva;
    reg [2:0] ACC_GX_for_acc_17_psp_1_sva;
    ...
    reg SHIFT_and_35_cse;
    reg SHIFT_and_28_cse;
    ...
    reg[0:0] ACC_GX_mux_38_nl;
    reg[0:0] ACC3_mux_4_nl;
    reg[0:0] ACC_GX_mux_42_nl;
    begin : core_rlpExit
        ...
        begin : mainExit
          forever begin : main
            ...
            if ( exit_ACC3_lpi_1_dfm ) begin
              regs_operator_din_sva = vin_rsc_mgc_in_wire_d[149:0];
            end
            ...
            redarray_3_lpi_1_dfm = redarray_3_lpi_1 & (signext_16_1(~ exit_ACC3_lpi_1_dfm));
            redarray_4_lpi_1_dfm = redarray_4_lpi_1 & (signext_16_1(~ exit_ACC3_lpi_1_dfm));
            ...
            greenarray_3_lpi_1_dfm = greenarray_3_lpi_1 & (signext_16_1(~ exit_ACC3_lpi_1_dfm));
            greenarray_4_lpi_1_dfm = greenarray_4_lpi_1 & (signext_16_1(~ exit_ACC3_lpi_1_dfm));
            ...
            bluearray_3_lpi_1_dfm = bluearray_3_lpi_1 & (signext_16_1(~ exit_ACC3_lpi_1_dfm));
            bluearray_4_lpi_1_dfm = bluearray_4_lpi_1 & (signext_16_1(~ exit_ACC3_lpi_1_dfm));
            regs_operator_din_lpi_1_dfm = MUX_v_150_2_2({regs_operator_din_lpi_1_dfm
                , regs_operator_din_sva}, exit_ACC3_lpi_1_dfm);
            SHIFT_i_1_lpi_1_dfm_2 = MUX_v_3_2_2({SHIFT_i_1_lpi_3 , 3'b100}, exit_ACC3_lpi_1_dfm);
            ...
            if ( exit_SHIFT_lpi_1_dfm ) begin
              if ( exit_ACC_GX_1_lpi_1_dfm ) begin
                ...
                ACC3_mux_5_nl = MUX_v_16_8_2({bluearray_0_lpi_1_dfm , bluearray_1_lpi_1_dfm
                    , bluearray_2_lpi_1_dfm , bluearray_3_lpi_1_dfm , bluearray_4_lpi_1_dfm
                    , 16'b0 , 16'b0 , 16'b0}, FRAME_a_3_lpi_1);
                blue_sva_1 = blue_lpi_1_dfm + (ACC3_mux_5_nl);
                ACC3_mux_6_nl = MUX_v_16_8_2({greenarray_0_lpi_1_dfm , greenarray_1_lpi_1_dfm
                ...
                ACC_GX_for_acc_16_psp_sva = conv_s2u_4_6({1'b1 , (~ FRAME_a_4_lpi_1)})
                    + ({(FRAME_a_4_lpi_1[1:0]) , 4'b1});
                ACC_GX_for_acc_17_psp_1_sva = conv_u2u_2_3(FRAME_i_1_lpi_1[2:1])
                    + FRAME_i_1_lpi_1;
                ...
                ACC_GX_for_mux_21_nl = MUX_s_1_32_2({1'b0 , 1'b0 , 1'b0 , 1'b0 ,
                    1'b0 , 1'b0 , 1'b0 , 1'b1 , 1'b0 , 1'b0 , 1'b0 , 1'b1 , 1'b1
                    , 1'b1 , 1'b0 , 1'b0 , 1'b0 , 1'b1 , 1'b0 , 1'b0 , 1'b0 , 1'b0
                    , 1'b0 , 1'b0 , 1'b0 , 1'b0 , 1'b0 , 1'b0 , 1'b0 , 1'b0 , 1'b0
                    , 1'b0}, conv_u2u_3_5(FRAME_a_4_lpi_1) + conv_u2u_4_5({ACC_GX_for_acc_17_psp_1_sva
                    , (FRAME_i_1_lpi_1[0])}));
                ACC_GX_for_acc_1_ctmp_sva = (ACC_GX_for_mux_nl) + conv_s2s_11_16((conv_s2s_10_11(fsar_10_150_8((~
                    regs_operator_slc_regs_regs_cse_sva), ({(conv_u2u_5_6(ACC_GX_for_acc_16_psp_sva[5:1])
                    + 6'b101) , (ACC_GX_for_acc_16_psp_sva[0]) , 1'b0}))) + 11'b1)
                    & (signext_11_1(ACC_GX_for_mux_21_nl)));
                and_stg_8_sva = ~((FRAME_a_4_lpi_1[1]) | (FRAME_a_4_lpi_1[0]));
                ACC_GX_for_slc_gx_1_cse_sva = MUX_s_1_32_2({1'b0 , 1'b0 , 1'b0 ,
                    1'b0 , 1'b0 , 1'b0 , 1'b0 , 1'b1 , 1'b0 , 1'b0 , 1'b0 , 1'b1
                    , 1'b1 , 1'b1 , 1'b0 , 1'b0 , 1'b0 , 1'b1 , 1'b0 , 1'b0 , 1'b0
                    , 1'b0 , 1'b0 , 1'b0 , 1'b0 , 1'b0 , 1'b0 , 1'b0 , 1'b0 , 1'b0
                    , 1'b0 , 1'b0}, conv_u2u_4_5({ACC_GX_for_acc_17_psp_1_sva , (FRAME_i_1_lpi_1[0])})
                ...
                ACC_GX_for_mux_24_nl = MUX_v_10_64_2({(~ (regs_operator_slc_regs_regs_cse_sva[137:128]))
                    , (~ (regs_operator_slc_regs_regs_cse_sva[139:130])) , 10'b0
                    , 10'b0 , 10'b0 , (~ (regs_operator_slc_regs_regs_cse_sva[19:10]))
                    ...
                    , (~ (regs_operator_slc_regs_regs_cse_sva[73:64])) , (~ (regs_operator_slc_regs_regs_cse_sva[75:66]))
                    , (~ (regs_operator_slc_regs_regs_cse_sva[77:68])) , (~ (regs_operator_slc_regs_regs_cse_sva[79:70]))
                    , (~ (regs_operator_slc_regs_regs_cse_sva[81:72])) , (~ (regs_operator_slc_regs_regs_cse_sva[83:74]))
                    , (~ (regs_operator_slc_regs_regs_cse_sva[85:76])) , (~ (regs_operator_slc_regs_regs_cse_sva[87:78]))
                    , (~ (regs_operator_slc_regs_regs_cse_sva[89:80])) , (~ (regs_operator_slc_regs_regs_cse_sva[91:82]))
                    , (~ (regs_operator_slc_regs_regs_cse_sva[93:84])) , (~ (regs_operator_slc_regs_regs_cse_sva[95:86]))
                    , (~ (regs_operator_slc_regs_regs_cse_sva[97:88])) , (~ (regs_operator_slc_regs_regs_cse_sva[99:90]))
                    , (~ (regs_operator_slc_regs_regs_cse_sva[101:92])) , (~ (regs_operator_slc_regs_regs_cse_sva[103:94]))
                    , (~ (regs_operator_slc_regs_regs_cse_sva[105:96])) , (~ (regs_operator_slc_regs_regs_cse_sva[107:98]))
                    , (~ (regs_operator_slc_regs_regs_cse_sva[109:100])) , (~ (regs_operator_slc_regs_regs_cse_sva[111:102]))
                    , (~ (regs_operator_slc_regs_regs_cse_sva[113:104])) , (~ (regs_operator_slc_regs_regs_cse_sva[115:106]))
                    , (~ (regs_operator_slc_regs_regs_cse_sva[117:108])) , (~ (regs_operator_slc_regs_regs_cse_sva[119:110]))
                    , (~ (regs_operator_slc_regs_regs_cse_sva[121:112])) , (~ (regs_operator_slc_regs_regs_cse_sva[123:114]))
                    , (~ (regs_operator_slc_regs_regs_cse_sva[125:116])) , (~ (regs_operator_slc_regs_regs_cse_sva[127:118]))
                    , (~ (regs_operator_slc_regs_regs_cse_sva[129:120])) , (~ (regs_operator_slc_regs_regs_cse_sva[131:122]))
                    , (~ (regs_operator_slc_regs_regs_cse_sva[133:124])) , (~ (regs_operator_slc_regs_regs_cse_sva[135:126]))},
                    ACC_GX_for_acc_16_psp_sva + 6'b101);
                ACC_GX_for_acc_5_ctmp_sva = (ACC_GX_for_mux_23_nl) + conv_s2s_11_16((conv_s2s_10_11(ACC_GX_for_mux_24_nl)
                ...
                ACC_GX_for_acc_9_ctmp_sva = (ACC_GX_for_mux_25_nl) + conv_s2s_11_16((conv_s2s_10_11(ACC_GX_for_mux_26_nl)
                    + 11'b1) & ({{10{ACC_GX_for_slc_gx_1_cse_sva}}, ACC_GX_for_slc_gx_1_cse_sva}));
            ...
            SHIFT_and_48_cse = exit_ACC3_sva_2 & exit_ACC_GX_1_lpi_1_dfm & exit_SHIFT_lpi_1_dfm;
            ...
            ACC3_mux_4_nl = MUX_s_1_2_2({exit_FRAME_lpi_1_dfm , (FRAME_p_1_sva_1[1])},
                exit_ACC3_sva_2);
            ACC_GX_mux_38_nl = MUX_s_1_2_2({exit_FRAME_lpi_1_dfm , (ACC3_mux_4_nl)},
                exit_ACC_GX_1_lpi_1_dfm);
            exit_FRAME_lpi_1_dfm_3 = MUX_s_1_2_2({exit_FRAME_lpi_1_dfm , (ACC_GX_mux_38_nl)},
                exit_SHIFT_lpi_1_dfm);
            exit_ACC3_lpi_1_dfm_5 = MUX_s_1_2_2({SHIFT_and_48_cse , (SHIFT_and_48_cse
                | (~ (FRAME_p_1_lpi_1_dfm_3[1])))}, SHIFT_and_48_cse);
            ...
            SHIFT_and_31_cse = (~ (FRAME_a_4_lpi_1[2])) & and_stg_8_sva & (~ exit_ACC_GX_1_lpi_1_dfm)
                & exit_SHIFT_lpi_1_dfm;
            ...
            redarray_2_lpi_1 = MUX_v_16_2_2({redarray_2_lpi_1_dfm , ACC_GX_for_acc_1_ctmp_sva},
                SHIFT_and_33_cse);
            SHIFT_and_34_cse = (~ (FRAME_a_4_lpi_1[2])) & (FRAME_a_4_lpi_1[1]) &
                (FRAME_a_4_lpi_1[0]) & (~ exit_ACC_GX_1_lpi_1_dfm) & exit_SHIFT_lpi_1_dfm;
            redarray_3_lpi_1 = MUX_v_16_2_2({redarray_3_lpi_1_dfm , ACC_GX_for_acc_1_ctmp_sva},
                SHIFT_and_34_cse);
            SHIFT_and_35_cse = (FRAME_a_4_lpi_1[2]) & and_stg_8_sva & (~ exit_ACC_GX_1_lpi_1_dfm)
                & exit_SHIFT_lpi_1_dfm;
            ...
            greenarray_2_lpi_1 = MUX_v_16_2_2({greenarray_2_lpi_1_dfm , ACC_GX_for_acc_5_ctmp_sva},
                SHIFT_and_33_cse);
            greenarray_3_lpi_1 = MUX_v_16_2_2({greenarray_3_lpi_1_dfm , ACC_GX_for_acc_5_ctmp_sva},
                SHIFT_and_34_cse);
            greenarray_4_lpi_1 = MUX_v_16_2_2({greenarray_4_lpi_1_dfm , ACC_GX_for_acc_5_ctmp_sva},
                SHIFT_and_35_cse);
            ...
            bluearray_2_lpi_1 = MUX_v_16_2_2({bluearray_2_lpi_1_dfm , ACC_GX_for_acc_9_ctmp_sva},
                SHIFT_and_33_cse);
            bluearray_3_lpi_1 = MUX_v_16_2_2({bluearray_3_lpi_1_dfm , ACC_GX_for_acc_9_ctmp_sva},
                SHIFT_and_34_cse);
            bluearray_4_lpi_1 = MUX_v_16_2_2({bluearray_4_lpi_1_dfm , ACC_GX_for_acc_9_ctmp_sva},
                SHIFT_and_35_cse);
            SHIFT_and_28_cse = exit_ACC_GX_1_lpi_1_dfm & exit_SHIFT_lpi_1_dfm;
            FRAME_a_3_lpi_1 = MUX1HOT_v_3_3_2({FRAME_a_3_sva , FRAME_a_3_lpi_1_dfm
                , FRAME_a_3_lpi_1}, {SHIFT_and_28_cse , ((~ exit_ACC_GX_1_lpi_1_dfm)
                & exit_SHIFT_lpi_1_dfm) , (~ exit_SHIFT_lpi_1_dfm)});
            ACC_GX_and_20_tmp = exit_ACC_GX_for_sva & (~ exit_ACC_GX_1_lpi_1_dfm);
            FRAME_i_1_lpi_1 = MUX1HOT_v_3_3_2({FRAME_i_1_lpi_1_dfm_2 , FRAME_i_1_lpi_1
                , FRAME_i_1_sva}, {(~ exit_SHIFT_lpi_1_dfm) , ((~ ACC_GX_and_20_tmp)
                & exit_SHIFT_lpi_1_dfm) , (ACC_GX_and_20_tmp & exit_SHIFT_lpi_1_dfm)});
            ...
            FRAME_a_4_lpi_1 = MUX1HOT_v_3_4_2({FRAME_a_4_lpi_1_dfm_3 , FRAME_a_4_lpi_1
                ...
                , SHIFT_and_28_cse , (exit_ACC_GX_for_sva & (~ exit_ACC_GX_1_lpi_1_dfm)
                & exit_SHIFT_lpi_1_dfm) , ((~(exit_ACC_GX_for_sva | exit_ACC_GX_1_lpi_1_dfm))
                & exit_SHIFT_lpi_1_dfm)});
            ACC_GX_mux_42_nl = MUX_s_1_2_2({exit_ACC_GX_1_sva_1 , exit_ACC_GX_1_lpi_1_dfm},
                exit_ACC_GX_1_lpi_1_dfm);
            exit_ACC_GX_1_lpi_1 = MUX_s_1_2_2({exit_ACC_GX_1_lpi_1_dfm , (ACC_GX_mux_42_nl)},
                exit_SHIFT_lpi_1_dfm);
    ...
    SHIFT_and_28_cse = 1'b0;
    SHIFT_and_35_cse = 1'b0;
    ...
    ACC_GX_for_acc_17_psp_1_sva = 3'b0;
    ACC_GX_for_acc_16_psp_sva = 6'b0;
    FRAME_p_1_sva_1 = 2'b0;
