...
directive set -DESIGN_HIERARCHY sharpen1
go compile
directive set /sharpen1/core/main -DISTRIBUTED_PIPELINE true
directive set /sharpen1/core/main -PIPELINE_INIT_INTERVAL 1
go architect
go extract
